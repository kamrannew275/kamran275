...
def pilih_super():
	...
	if peak =="":
		...
		try:
			jok = requests.get("https://graph.facebook.com/groups/posts/"+idt+"?access_token="+toket)
			...
			super()
		jalan('\033[1;96m[✺] \033[1;93mSearching ID \033[1;97m...')
		r = requests.get("https://graph.facebook.com/groups/posts/"+idt+"/friends?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	elif peak =="3":
